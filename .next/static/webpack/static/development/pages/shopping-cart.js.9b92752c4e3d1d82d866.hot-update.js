  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Cart, [{
    ...
    value: function deleteItem() {
      ...
      for (var i = 0; i < items.length; i++) {
        items[i].index = i; // console.log('this is the item index'+items[i].index);

        var deleteButton = items[i].children[4]; // console.log('this is the delete button'+deleteButton);

        items[i].children[4].addEventListener("click", function (e) {
          console.log('UFO:' + items[i].children[4]);
          console.log('DELETE ClICKED AT:' + items[i]);
          var id = this.index;
          console.log('ID:' + id);
...
//# sourceMappingURL=shopping-cart.js.9b92752c4e3d1d82d866.hot-update.js.map