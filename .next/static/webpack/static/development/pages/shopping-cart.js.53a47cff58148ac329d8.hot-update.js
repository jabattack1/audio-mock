  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Cart, [{
    ...
    value: function deleteItem() {
      ...
      for (var i = 0; i < items.length; i++) {
        ...
        var deleteButton = items[i].children[4];
        var ufo = items[i];
        console.log('before:' + ufo); // console.log('this is the delete button'+deleteButton);

        deleteButton.addEventListener("click", function (e) {
          console.log('DELETE ClICKED AT:' + items[i]);
          console.log('UFO:' + ufo.index);
          var id = this.index;
          console.log('ID:' + id);
...
//# sourceMappingURL=shopping-cart.js.53a47cff58148ac329d8.hot-update.js.map