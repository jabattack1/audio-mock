    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "addToCart", function () {
      ...
      if (myData !== null) {
        ...
        if (otherStuff.length > 1) {
          ...
          localStorage.setItem('state', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(array));
        }

        console.log(newArray); // console.log(JSON.parse(stuff));
      } else {
        console.log('genie');
...
//# sourceMappingURL=store.js.136091ea50e2edf11343.hot-update.js.map