      ...
      var _loop = function _loop() {
        ...
        selectOption.addEventListener("change", function () {
          ...
          if (data.length === undefined) {
            ...
            console.log(total);
            data.price = total.toFixed(2);
            console.log('thisisis' + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data));
            localStorage.clear();
            localStorage.setItem('state', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data));
            console.log('this is it' + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data)); // location.reload();
          } else {
...
//# sourceMappingURL=shopping-cart.js.f5b8566356c3b8347b53.hot-update.js.map