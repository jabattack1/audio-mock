      ...
      var _loop = function _loop() {
        ...
        selectOption.addEventListener("change", function () {
          ...
          if (data.length === undefined) {
            ...
            console.log('oneB');
            data[0].quantity = item[0].children[3].children[0].value;
            var multiple = item[0].children[3].children[0].value;
            var total = multiple * item[0].children[6].innerHTML;
            data.price = total.toFixed(2);
            localStorage.clear();
            localStorage.setItem('state', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data));
            location.reload();
...
//# sourceMappingURL=shopping-cart.js.b53c9513a473579ea6f4.hot-update.js.map