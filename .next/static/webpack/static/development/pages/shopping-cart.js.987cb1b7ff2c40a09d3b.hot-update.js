  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(ShoppingCart, [{
    ...
    value: function render() {
      ...
      if (this.state.data === '') {
        return react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("div", {
          ...
          __self: this
        }, "If you are having trouble, please check the Terms & Conditions of the promotion, which are usually found by clicking \"See Details\" where the promotion was found online or in the footer of the email or mail."), react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("input", {
          id: "promoField",
          type: "text",
          __source: {
            fileName: _jsxFileName,
    ...
    value: function showPromo() {
      ...
      if (down === true) {
        ...
        down = false; // promo.style.display = "none";
      } else {
        icon.className = 'fa-arrow-up'; // promo.style.display = "block";
...
//# sourceMappingURL=shopping-cart.js.987cb1b7ff2c40a09d3b.hot-update.js.map