...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(ShoppingCart, [{
    ...
    value: function showPopup2() {
      var specifiedElement = document.getElementsById('popup2');
      document.addEventListener('click', function (event) {
        var isClickInside = specifiedElement.contains(event.target);

        if (isClickInside) {
          alert('You clicked inside popup2');
        } else {
          alert('You clicked outside popup2');
        }
      }); // console.log('pop2');
    ...
    value: function twoClicks() {
      // console.log('twos');
      var x = document.getElementById("popup1");
      var y = document.getElementById("popup2"); // console.log(y.style.display);
...
//# sourceMappingURL=shopping-cart.js.f1f0f413cddaee0bbaa8.hot-update.js.map