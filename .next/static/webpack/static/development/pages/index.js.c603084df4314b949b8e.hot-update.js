...
if (true) {
  window.onload = function () {
    ...
    function moveIndicator(item, color) {
      ...
      pnIndicator.style.transform = "translateX(" + (distance + scroll) + "px) scaleX(" + textPosition.width * 5 + ")"; // count = count += 100;
...
//# sourceMappingURL=index.js.c603084df4314b949b8e.hot-update.js.map