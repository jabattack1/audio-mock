...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(ShoppingCart, [{
    ...
    value: function twoClicks() {
      var popup2 = document.getElementById('popup2'); //I'm using "click" but it works with any event

      document.addEventListener('click', function (event) {
        var isClickInside = popup2.contains(event.target);
      ...
      var x = document.getElementById("popup1"); // console.log(y.style.display);
...
//# sourceMappingURL=shopping-cart.js.96996ecefcab9393b169.hot-update.js.map