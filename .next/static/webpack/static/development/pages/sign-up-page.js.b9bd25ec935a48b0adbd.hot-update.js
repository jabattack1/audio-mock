...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SignUp, [{
    ...
    value: function checkFemale() {
      checkbox = document.getElementById("femaleCheck");
      console.log('stimpy');
      var isChecked = document.getElementById('femaleCheck').checked;
      console.log(isChecked); // if(document.getElementById('maleCheck').check == true){
      // 	console.log('time');
      // $('#gender').val('female');
...
//# sourceMappingURL=sign-up-page.js.b9bd25ec935a48b0adbd.hot-update.js.map