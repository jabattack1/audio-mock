...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Navbar, [{
    ...
    value: function componentDidMount() {
      react_scroll__WEBPACK_IMPORTED_MODULE_9__["Events"].scrollEvent.register('begin', function () {
        console.log("begin", arguments);
      });
      react_scroll__WEBPACK_IMPORTED_MODULE_9__["Events"].scrollEvent.register('end', function () {
    ...
    value: function scrollTo() {
      react_scroll__WEBPACK_IMPORTED_MODULE_9__["scroller"].scrollTo('scroll-to-element', {
        duration: 800,
        delay: 0,
    ...
    value: function scrollToWithContainer() {
      var goToContainer = new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
        react_scroll__WEBPACK_IMPORTED_MODULE_9__["Events"].scrollEvent.register('end', function () {
          resolve();
          react_scroll__WEBPACK_IMPORTED_MODULE_9__["Events"].scrollEvent.remove('end');
        });
        react_scroll__WEBPACK_IMPORTED_MODULE_9__["scroller"].scrollTo('scroll-container', {
          duration: 800,
          delay: 0,
          smooth: 'easeInOutQuart'
        });
      ...
      goToContainer.then(function () {
        return react_scroll__WEBPACK_IMPORTED_MODULE_9__["scroller"].scrollTo('scroll-container-second-element', {
          duration: 800,
          delay: 0,
          smooth: 'easeInOutQuart',
    ...
    value: function componentWillUnmount() {
      react_scroll__WEBPACK_IMPORTED_MODULE_9__["Events"].scrollEvent.remove('begin');
      react_scroll__WEBPACK_IMPORTED_MODULE_9__["Events"].scrollEvent.remove('end');
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.bf5e8e1281749881178f.hot-update.js.map