  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Cart, [{
    ...
    value: function setQuantity() {
      ...
      var _loop = function _loop() {
        ...
        selectOption = items[k].children[4];
        selectOption.addEventListener("change", function () {
          ...
          if (data.length === undefined) {
            ...
            var multiple = selected.children[4].children[0].value;
            var total = multiple * selected.children[7].innerHTML;
            ...
            for (var i = 0; i < data.length; i++) {
              if (i === id) {
                ...
                var multiple = items[i].children[4].children[0].value;
                var total = multiple * items[i].children[7].innerHTML;
...
//# sourceMappingURL=shopping-cart.js.fe72c9c6a0215cf0c724.hot-update.js.map