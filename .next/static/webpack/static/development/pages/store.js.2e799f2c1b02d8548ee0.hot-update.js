    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "addToCart", function () {
      ...
      if (myData !== null) {
        ...
        if (otherStuff.length > 1) {
          ...
          var array = newArray.push(newStuff);
          console.log(array);
        } else {
          console.log('dog');
          var _array = [otherStuff, newStuff];

          var _stuff = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, _array);

          localStorage.setItem('state', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(_array));
...
//# sourceMappingURL=store.js.2e799f2c1b02d8548ee0.hot-update.js.map