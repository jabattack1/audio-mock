  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SignUp, [{
    ...
    value: function checkMale() {
      ...
      if (femaleColor === 'white') {} else {
        ...
        document.getElementById('femaleCheck').style.backgroundColor = 'white'; // this.setState({gender:'male'});
    ...
    value: function checkFemale() {
      ...
      if (maleColor === 'white') {} else {
        ...
        document.getElementById('maleCheck').style.backgroundColor = 'white'; // this.setState({gender:'female'});
...
//# sourceMappingURL=store.js.a2770bf6e7af02cf5cf7.hot-update.js.map