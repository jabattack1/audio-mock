  ...
  window.onload = function () {
    ...
    pnAdvancerRightStore.addEventListener("click", function () {
      ...
      if (determineOverflowStore(pnProductNavContentsStore, pnProductNavStore) === "right" || determineOverflowStore(pnProductNavContentsStore, pnProductNavStore) === "both") {
        ...
        var availableScrollRight = Math.floor(navBarRightEdgeStore - navBarScrollerRightEdgeStore); // If the space available is less than two lots of our desired distance, just move the whole amount
        // otherwise, move by the amount in the settingsStore
    ...
    pnProductNavContentsStore.addEventListener("click", function (e) {
      ...
      moveIndicatorStore(e.target, coloursStore[links.indexOf(e.target)]);
    }); // var count = 0;
...
//# sourceMappingURL=index.js.63cfe5b9919c17ba1540.hot-update.js.map