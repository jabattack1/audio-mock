...
if (true) {
  window.onload = function () {
    ...
    pnProductNavStore.setAttribute("data-overflowing", determineOverflow(pnProductNavContents, pnProductNavStore)); // Set the indicator
    ...
    function doSomething(scroll_pos) {
      pnProductNavStore.setAttribute("data-overflowing", determineOverflow(pnProductNavContents, pnProductNavStore));
    }
    ...
    pnAdvancerLeft.addEventListener("click", function () {
      ...
      if (determineOverflow(pnProductNavContents, pnProductNavStore) === "left" || determineOverflow(pnProductNavContents, pnProductNavStore) === "both") {
    ...
    pnAdvancerRight.addEventListener("click", function () {
      ...
      if (determineOverflow(pnProductNavContents, pnProductNavStore) === "right" || determineOverflow(pnProductNavContents, pnProductNavStore) === "both") {
...
//# sourceMappingURL=index.js.3af59ae753d1988ad549.hot-update.js.map