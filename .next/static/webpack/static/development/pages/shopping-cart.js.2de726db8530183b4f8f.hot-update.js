...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Cart, [{
    ...
    value: function componentDidMount() {
      var items = document.querySelectorAll(".cartList");
      console.log('these are all the items' + items);

      for (var i = 0; i < items.length; i++) {
        console.log(items[i].children[5].innerHTML);
      }
...
//# sourceMappingURL=shopping-cart.js.2de726db8530183b4f8f.hot-update.js.map