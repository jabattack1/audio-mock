  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Cart, [{
    ...
    value: function setQuantity() {
      ...
      for (var k = 0; k < items.length; k++) {
        ...
        items[k].children[3].addEventListener("change", function () {
          var id = this.index;
    ...
    value: function deleteItem() {
      ...
      for (var i = 0; i < items.length; i++) {
        items[i].index = i;
        items[i].children[4].addEventListener("click", function () {
          ...
          for (var i = 0; i < items.length; i++) {
            ...
            var myData = localStorage.getItem('state');
            var data = JSON.parse(myData);
            console.log('this is the item index:' + items[i].index);
            console.log('this is the data length:' + data.length);
            console.log('this is the items length:' + items.length); // console.log('this is the index:'+i)
            ...
            if (data.length === undefined || data.length === 1) {
              ...
              for (var i = 0; i < data.length; i++) {
                if (i === id) {
                  ...
                  localStorage.clear();
                  localStorage.setItem('state', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data)); // location.reload();
                }
              }
            }
          }
...
//# sourceMappingURL=shopping-cart.js.be863fec04674d579849.hot-update.js.map