  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Items, [{
    ...
    value: function componentDidMount() {
      ...
      if (result.length < 1) {
        ...
        if (typeof window !== 'undefined') {
          localStorage.clear();
          localStorage.setItem('code', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(result[0].id));
        }

        console.log('result', result[0]);
        result[0].map(function (e) {
          return _this3.state = {
            code: e.code,
...
//# sourceMappingURL=store.js.6529a906575a3a6c4eed.hot-update.js.map