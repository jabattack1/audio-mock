    ...
    value: function render() {
      ...
      if (typeof window !== 'undefined') {
        ...
        if (data !== 'nothing') {
          ...
          if (parsedData !== null) {
            console.log('lengthPraed' + parsedData.length);

            if (parsedData.length !== undefined) {
              for (var i in parsedData) {
                console.log('moon');
                console.log('math' + _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(parsedData[i].quantity));
      ...
      return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", {
        ...
        __self: this
      }, this.state.name), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(react_scroll__WEBPACK_IMPORTED_MODULE_11__["Link"], {
        href: "/shopping-cart",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 56
...
//# sourceMappingURL=shopping-cart.js.c173afe7ebb3f40e83ee.hot-update.js.map