...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SignUp, [{
    ...
    value: function checkFemale() {
      var ele = document.getElementById('femaleCheck');

      ele.onchange = function () {
        console.log('wtf');
        var test = document.getElementById(maleCheck).checked;
        console.log(test);
      }; // console.log('stimpy');
      ...
      if (document.getElementById('maleCheck').check == true) {
        console.log('time'); // $('#gender').val('female');
        // $('#femaleCheck').removeClass('signupOption').addClass('highlight');
        // $('#male').attr('checked', false);
        // $('#maleCheck').removeClass('highlight').addClass('signupOption');
        // evt.stopPropagation();
      } else {// $('#femaleCheck').removeClass('highlight').addClass('signupOption');
          // evt.stopPropagation();
          // $('#gender').val('');
        }
    }
...
//# sourceMappingURL=sign-up-page.js.26b951ab8b00235dbd26.hot-update.js.map