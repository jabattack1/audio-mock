  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Cart, [{
          ...
          if (data.length === undefined) {
            ...
            for (var i = 0; i < data.length; i++) {
              if (i === id) {
                ...
                var by = items[i].children[3].children[0].value;
                console.log(items[i].children[5].innerHTML); // data[i].price = by * items[i].children[3]
    ...
    value: function deleteItem() {
      ...
      var _loop2 = function _loop2() {
        items[i].index = i;
        deleteButton = items[i].children[5];
        var ufo = items[i];
...
//# sourceMappingURL=shopping-cart.js.09dac3635b835b5172dc.hot-update.js.map