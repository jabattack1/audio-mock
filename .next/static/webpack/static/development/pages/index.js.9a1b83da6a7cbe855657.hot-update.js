    ...
    (function (root, factory) {
      ...
      var reset = function reset(i, el) {
        for (i = 0; i < dragged.length;) {
          el = dragged[i++];
          el = el.container || el;
          el[removeEventListener](mousedownStore, el.md, 0);

          _windowStore[removeEventListener](mouseupStore, el.mu, 0);

          _windowStore[removeEventListener](mousemoveStore, el.mm, 0);
        ...
        for (i = 0; i < dragged.length;) {
          (function (el, lastClientX, lastClientY, pushed, scroller, cont) {
            (cont = el.container || el)[addEventListener](mousedownStore, cont.md = function (e) {
            ...
            _windowStore[addEventListener](mouseupStore, cont.mu = function () {
              pushed = 0;
            }, 0);

            _windowStore[addEventListener](mousemoveStore, cont.mm = function (e) {
              if (pushed) {
                (scroller = el.scroller || el).scrollLeft -= newScrollX = -lastClientX + (lastClientX = e.clientX);
                scroller.scrollTop -= newScrollY = -lastClientY + (lastClientY = e.clientY);

                if (el == _documentStore.body) {
                  (scroller = _documentStore.documentElement).scrollLeft -= newScrollX;
...
//# sourceMappingURL=index.js.9a1b83da6a7cbe855657.hot-update.js.map